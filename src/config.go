...
type config struct {
	...
	ExternalClientID string `arg:"--external-client-id,env:EXTERNAL_CLIENT_ID,required" help:"the external client id"`
	ExternalTenantID string `arg:"--external-tenant-id,env:EXTERNAL_TENANT_ID,required" help:"the external tenant id"`
}
